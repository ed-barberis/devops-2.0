...
2.	Install the [Homebrew 4.4.26](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
...
4.	Install [Packer 1.12.0 for Windows 64-bit](https://releases.hashicorp.com/packer/1.12.0/packer_1.12.0_windows_amd64.zip).
