...
6.	Install [Packer 1.8.5](https://packer.io/) for macOS 64-bit.  
...
4.	Install [Packer 1.8.5 for Windows 64-bit](https://releases.hashicorp.com/packer/1.8.5/packer_1.8.5_windows_amd64.zip).
