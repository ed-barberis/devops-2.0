...
-	VirtualBox 7.2.2
	-	VirtualBox Extension Pack 7.2.2
...
2.	Install the [Homebrew 4.6.14](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    `$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"`

3.	Install [VirtualBox 7.2.2](https://www.virtualbox.org/) for macOS 64-bit.  
...
4.	Install [VirtualBox Extension Pack 7.2.2](https://www.virtualbox.org/) for macOS 64-bit.  
    `$ brew cask install virtualbox-extension-pack`  

5.	Install [Vagrant 2.4.9](https://www.vagrantup.com/) for macOS 64-bit.  
    `$ brew cask install vagrant`  

6.	Install [Packer 1.14.2](https://packer.io/) for macOS 64-bit.  
    `$ brew install hashicorp/tap/packer`  

7.	Install [Git 2.51.0](https://git-scm.com/downloads) for macOS 64-bit.  
    `$ brew install git`  

8.	Install [jq 1.8.1](https://jqlang.github.io/jq/) for macOS 64-bit.  
    `$ brew install jq`  
...
1.	Install [VirtualBox 7.2.2 for Windows 64-bit](https://download.virtualbox.org/virtualbox/7.2.2/VirtualBox-7.2.2-170484-Win.exe).

2.	Install [VirtualBox Extension Pack 7.2.2](https://download.virtualbox.org/virtualbox/7.2.2/Oracle_VirtualBox_Extension_Pack-7.2.2-170484.vbox-extpack).
...
4.	Install [Packer 1.14.2 for Windows 64-bit](https://releases.hashicorp.com/packer/1.14.2/packer_1.14.2_windows_amd64.zip).
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\Packer\bin`  

5.	Install [Git 2.51.0 for Windows 64-bit](https://github.com/git-for-windows/git/releases/download/v2.51.0.windows.1/Git-2.51.0-64-bit.exe) for Windows 64-bit.

6.	Install [jq 1.8.1](https://github.com/jqlang/jq/releases/download/jq-1.8.1/jq-win64.exe) for Windows 64-bit.  
