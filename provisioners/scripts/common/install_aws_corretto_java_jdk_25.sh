#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install Amazon Corretto 25 OpenJDK by Amazon.
#
...
# set amazon corretto 25 installation variables. ---------------------------------------------------
jdk_home="jdk25"
jdk_build="25.0.0.36.2"
jdk_pgpkey_file="B04F24E3.pub"

# set the jdk sha256 and arch values based on cpu architecture.
if [ "$cpu_arch" = "x86_64" ]; then
  # set the amd64 variables.
  jdk_sha256="7fa3a845e2a2197d01d875889597d4196e3da310c85a4687d4214a4161cdccd0"
  jdk_arch="x64"
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  jdk_sha256="9d25b07aff40d98b5fa6879ce4b31dd062a9c0a5283aacf42b2a1e41b61ae419"
  jdk_arch="aarch64"
else
...
# download and validate corretto 25 binary from aws. -----------------------------------------------
# download the corretto 25 binary.
rm -f ${jdk_binary}
...
# download the corretto 25 pgp signature.
rm -f ${jdk_sig_file}
...
# import the corretto 25 public key.
...
# extract corretto 25 binary and create softlink to 'jdk25'.
...
# set corretto 25 home environment variables.
