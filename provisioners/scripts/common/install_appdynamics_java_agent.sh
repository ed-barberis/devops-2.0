...
appd_java_agent_release="${appd_java_agent_release:-23.6.0.34839}"
appd_java_agent_sha256="${appd_java_agent_sha256:-c9f85c78032b9438e671f2c532ec22bea49724539a81208496a2ea1789feefc1}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.6.0.34839"               # [optional] java agent release (defaults to '23.6.0.34839').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="c9f85c78032b9438e671f2c532ec22bea49724539a81208496a2ea1789feefc1"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.6.0.34839/conf/controller-info.xml'
