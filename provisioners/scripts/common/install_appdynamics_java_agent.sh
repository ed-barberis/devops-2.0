...
appd_java_agent_release="${appd_java_agent_release:-23.6.1.34894}"
appd_java_agent_sha256="${appd_java_agent_sha256:-ca4685059ad98c704851259716a39ef6e751afcd265122bcbbc1ccfed95c91d8}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.6.1.34894"               # [optional] java agent release (defaults to '23.6.1.34894').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="ca4685059ad98c704851259716a39ef6e751afcd265122bcbbc1ccfed95c91d8"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.6.1.34894/conf/controller-info.xml'
