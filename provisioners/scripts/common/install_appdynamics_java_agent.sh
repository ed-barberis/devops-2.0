...
appd_java_agent_release="${appd_java_agent_release:-25.8.0.37285}"
appd_java_agent_sha256="${appd_java_agent_sha256:-62816005cf3d107e300803c16dfc5235f05349cb84da3a19e688fca671b35629}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="25.8.0.37285"               # [optional] java agent release (defaults to '25.8.0.37285').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="62816005cf3d107e300803c16dfc5235f05349cb84da3a19e688fca671b35629"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver25.8.0.37285/conf/controller-info.xml'
