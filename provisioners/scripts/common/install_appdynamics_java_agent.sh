...
appd_java_agent_release="${appd_java_agent_release:-22.9.1.34265}"
appd_java_agent_sha256="${appd_java_agent_sha256:-02ea2578e3d27d5f64581d9103c9dbb1440bc72d5206269de7c71f6244d430ad}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="22.9.1.34265"               # [optional] java agent release (defaults to '22.9.1.34265').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="02ea2578e3d27d5f64581d9103c9dbb1440bc72d5206269de7c71f6244d430ad"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver22.9.1.34265/conf/controller-info.xml'
