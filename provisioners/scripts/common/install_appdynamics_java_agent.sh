...
appd_java_agent_release="${appd_java_agent_release:-25.1.0.36709}"
appd_java_agent_sha256="${appd_java_agent_sha256:-58b8083b1fa39e84c718918271327d49395868c2585b220047973a51a130e2e3}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="25.1.0.36709"               # [optional] java agent release (defaults to '25.1.0.36709').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="58b8083b1fa39e84c718918271327d49395868c2585b220047973a51a130e2e3"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver25.1.0.36709/conf/controller-info.xml'
