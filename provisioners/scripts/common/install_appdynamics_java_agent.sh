...
appd_java_agent_release="${appd_java_agent_release:-24.8.1.36301}"
appd_java_agent_sha256="${appd_java_agent_sha256:-bf8ae5da0cdf83bfb677d7d2fb398853f5c5566c4de73b5f663acdfc1b34db3b}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="24.8.1.36301"               # [optional] java agent release (defaults to '24.8.1.36301').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="bf8ae5da0cdf83bfb677d7d2fb398853f5c5566c4de73b5f663acdfc1b34db3b"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver24.8.1.36301/conf/controller-info.xml'
