...
appd_java_agent_release="${appd_java_agent_release:-23.7.0.34957}"
appd_java_agent_sha256="${appd_java_agent_sha256:-1b19b4107317133598fff8668cd69dfe09a3599e9d6f4aa82059c49605947322}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.7.0.34957"               # [optional] java agent release (defaults to '23.7.0.34957').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="1b19b4107317133598fff8668cd69dfe09a3599e9d6f4aa82059c49605947322"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.7.0.34957/conf/controller-info.xml'
