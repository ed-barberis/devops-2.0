...
appd_java_agent_release="${appd_java_agent_release:-26.2.1.37810}"
appd_java_agent_sha256="${appd_java_agent_sha256:-1f5956d24472adc0c3040ede5c3e2db6efcd8c33190b72ad1985e99f14069484}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="26.2.1.37810"               # [optional] java agent release (defaults to '26.2.1.37810').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="1f5956d24472adc0c3040ede5c3e2db6efcd8c33190b72ad1985e99f14069484"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver26.2.1.37810/conf/controller-info.xml'
