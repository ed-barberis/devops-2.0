...
appd_java_agent_release="${appd_java_agent_release:-22.11.0.34486}"
appd_java_agent_sha256="${appd_java_agent_sha256:-054206d5f8f7da98ac53b0ef02f21bd3552983434ca81f7e5ebcffafb9818b0b}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="22.11.0.34486"              # [optional] java agent release (defaults to '22.11.0.34486').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="054206d5f8f7da98ac53b0ef02f21bd3552983434ca81f7e5ebcffafb9818b0b"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver22.11.0.34486/conf/controller-info.xml'
