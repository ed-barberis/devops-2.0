...
appd_java_agent_release="${appd_java_agent_release:-26.2.0.37684}"
appd_java_agent_sha256="${appd_java_agent_sha256:-0048bb9c8f11f190af3fb5f0aee03331dc18d9e5b265a843ded45bc604a2b2cc}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="26.2.0.37684"               # [optional] java agent release (defaults to '26.2.0.37684').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="0048bb9c8f11f190af3fb5f0aee03331dc18d9e5b265a843ded45bc604a2b2cc"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver26.2.0.37684/conf/controller-info.xml'
