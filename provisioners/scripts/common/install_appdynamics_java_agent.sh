...
appd_java_agent_release="${appd_java_agent_release:-23.4.0.34758}"
appd_java_agent_sha256="${appd_java_agent_sha256:-c28738b5e6b1a1e79c971f438838b09a31d7da573a6128e407b20d76bc022448}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.4.0.34758"               # [optional] java agent release (defaults to '23.4.0.34758').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="c28738b5e6b1a1e79c971f438838b09a31d7da573a6128e407b20d76bc022448"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.4.0.34758/conf/controller-info.xml'
