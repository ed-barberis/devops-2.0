...
appd_java_agent_release="${appd_java_agent_release:-25.12.0.37551}"
appd_java_agent_sha256="${appd_java_agent_sha256:-b2afd0430918a3fc97ad706f181b5756dfdf245337c5359da7d147b462f65840}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="25.12.0.37551"              # [optional] java agent release (defaults to '25.12.0.37551').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="b2afd0430918a3fc97ad706f181b5756dfdf245337c5359da7d147b462f65840"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver25.12.0.37551/conf/controller-info.xml'
