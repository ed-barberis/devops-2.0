...
appd_java_agent_release="${appd_java_agent_release:-25.2.0.36823}"
appd_java_agent_sha256="${appd_java_agent_sha256:-51206616e498ae427a93628994fc9419c56d993b6bad9ee195795c51ce2db980}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="25.2.0.36823"               # [optional] java agent release (defaults to '25.2.0.36823').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="51206616e498ae427a93628994fc9419c56d993b6bad9ee195795c51ce2db980"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver25.2.0.36823/conf/controller-info.xml'
