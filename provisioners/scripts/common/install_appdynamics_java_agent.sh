...
appd_java_agent_release="${appd_java_agent_release:-4.5.9.25648}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="4.5.9.25648"                # [optional] java agent release (defaults to '4.5.9.25648').
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver4.5.9.25648/conf/controller-info.xml'
