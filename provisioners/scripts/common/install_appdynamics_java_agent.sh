...
appd_java_agent_release="${appd_java_agent_release:-26.6.0.37963}"
appd_java_agent_sha256="${appd_java_agent_sha256:-a1c3b322c893a134437d2644f17fcc53879af4c64ca8abfc3ee7d9bdc31c5ac3}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="26.6.0.37963"               # [optional] java agent release (defaults to '26.6.0.37963').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="a1c3b322c893a134437d2644f17fcc53879af4c64ca8abfc3ee7d9bdc31c5ac3"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver26.6.0.37963/conf/controller-info.xml'
