#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install Amazon Corretto 17 OpenJDK by Amazon.
#
...
jdk_home="jdk17"
jdk_build="17.0.13.11.1"
jdk_pgpkey_file="B04F24E3.pub"

# set the jdk sha256 and arch values based on cpu architecture.
if [ "$cpu_arch" = "x86_64" ]; then
  # set the amd64 variables.
  jdk_sha256="31ccb0791940add3fa49b82fff5f87a65dbea27d294f58a753b9775f9752ecc7"
  jdk_arch="x64"
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  jdk_sha256="89ab3c3d0335243033c850153047399b5c028c2a61e842c3a5d1ca7809d46d1a"
  jdk_arch="aarch64"
else
...
# download and validate corretto 17 binary from aws. -----------------------------------------------
# download the corretto 17 binary.
rm -f ${jdk_binary}
...
# import the corretto 17 public key.
...
# extract corretto 17 binary and create softlink to 'jdk17'.
...
# set corretto 17 home environment variables.
