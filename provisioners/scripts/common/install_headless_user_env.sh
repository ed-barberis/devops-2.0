...
d_completion_release="${d_completion_release:-19.03.3}"
dc_completion_release="${dc_completion_release:-1.24.1}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="19.03.3"               # [optional] docker completion for bash release (defaults to '19.03.3').
    [root]# export dc_completion_release="1.24.1"               # [optional] docker compose completion for bash release (defaults to '1.24.1').
