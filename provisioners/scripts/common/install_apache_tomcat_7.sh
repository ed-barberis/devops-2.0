...
tomcat_release="${tomcat_release:-7.0.90}"                          # [optional] tomcat release (defaults to '7.0.90').
...
Usage:
  ...
  Example:
   # tomcat web server install parameters.
    ...
    [root]# export tomcat_release="7.0.90"                      # [optional] tomcat release (defaults to '7.0.90').
   #
