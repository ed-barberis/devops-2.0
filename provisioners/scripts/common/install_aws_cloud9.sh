...
case $user_host_os in
  ...
  "AlmaLinux 9.8 (Olive Jaguar)"|"CentOS Stream 9"|"Rocky Linux 9.8 (Blue Onyx)")
    dnf -y install dnf-plugins-core
    dnf -y install epel-release
...
case $user_host_os in
  ...
  "AlmaLinux 9.8 (Olive Jaguar)"|"Amazon Linux 2023"|"CentOS Stream 9"|"Fedora Linux 37 (Cloud Edition)"|"Fedora Linux 38 (Cloud Edition)"|"Fedora Linux 39 (Cloud Edition)"|"Oracle Linux Server 9.7"|"Rocky Linux 9.8 (Blue Onyx)"|"Ubuntu 20.04.6 LTS"|"Ubuntu 22.04.5 LTS")
