#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install Amazon Corretto 26 OpenJDK by Amazon.
#
...
# set amazon corretto 26 installation variables. ---------------------------------------------------
jdk_home="jdk26"
jdk_build="26.0.2.10.1"
jdk_pgpkey_file="B04F24E3.pub"

# set the jdk sha256 and arch values based on cpu architecture.
if [ "$cpu_arch" = "x86_64" ]; then
  # set the amd64 variables.
  jdk_sha256="6907fb2e953451e0c728f8767001102358420bc6919d920173d9dd1fb84c170c"
  jdk_arch="x64"
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  jdk_sha256="1ca39dbdaccf766ce7845c18a75157d6c54ea12c91931619c3cd4c46c9c3018c"
  jdk_arch="aarch64"
else
...
# download and validate corretto 26 binary from aws. -----------------------------------------------
# download the corretto 26 binary.
rm -f ${jdk_binary}
...
# download the corretto 26 pgp signature.
rm -f ${jdk_sig_file}
...
# import the corretto 26 public key.
...
# extract corretto 26 binary and create softlink to 'jdk26'.
...
# set corretto 26 home environment variables.
