#!/bin/bash -eux
#---------------------------------------------------------------------------------------------------
# Install MariaDB Community Server 12.2 Rolling by MariaDB on Ubuntu Linux.
#
...
if [ -n "$ubuntu_release" ]; then
  case $ubuntu_release in
      22.04|24.04|25.10)
        ;;
      *)
        echo "Error: MariaDB 12.2 NOT supported on Ubuntu release: '$(lsb_release -ds)'."
        exit 1
        ;;
  esac
fi
...
# MariaDB 12.2 repository list - created ${utc_date_time}
# https://mariadb.org/download/
X-Repolib-Name: MariaDB
Types: deb
# deb.mariadb.org is a dynamic mirror if your preferred mirror goes offline. See https://mariadb.org/mirrorbits/ for details.
# URIs: https://deb.mariadb.org/12.2/ubuntu
URIs: https://mirrors.gigenet.com/mariadb/repo/12.2/ubuntu
