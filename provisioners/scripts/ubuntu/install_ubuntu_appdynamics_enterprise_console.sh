...
appd_platform_release="${appd_platform_release:-25.7.2.10026}"
appd_platform_sha256="${appd_platform_sha256:-2c4f484ef6a2e4000498f1ce12f1b8bdde9a07f9855863983b627d1a4ebec57b}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="25.7.2.10026"                 # [optional] platform release (defaults to '25.7.2.10026').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="2c4f484ef6a2e4000498f1ce12f1b8bdde9a07f9855863983b627d1a4ebec57b"
