#!/bin/bash -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Community Server 9.6 by Oracle on Ubuntu Linux.
#
...
#   https://dev.mysql.com/doc/refman/9.6/en/linux-installation-apt-repo.html
...
if [ -n "$ubuntu_release" ]; then
  case $ubuntu_release in
      ...
      *)
        echo "Error: MySQL Community Server 9.6 NOT supported on Ubuntu release: '$(lsb_release -ds)'."
        exit 1
        ;;
  esac
fi
