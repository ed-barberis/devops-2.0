#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Community Server 8.4 by Oracle on CentOS Linux 10.x.
#
...
mysql_yum_checksum="${mysql_yum_checksum:-b163032ca564599e46c8ff02c0c79ba8}"
...
mysql_yum_binary="mysql${mysql_yum_release}-community-release-el10-2.noarch.rpm"
