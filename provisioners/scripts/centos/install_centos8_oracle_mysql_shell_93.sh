#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 9.4 by Oracle on CentOS Linux 8.x.
#
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-7f0f4e04e052ae371b817ab5f97ba423}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  mysqlsh_checksum="${mysqlsh_checksum:-5bd2fb553b86e497dd03c83d77fa5452}"  # [optional] mysql shell repository arm64 md5 checksum (defaults to published value).
else
