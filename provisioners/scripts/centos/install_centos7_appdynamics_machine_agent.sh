...
appd_machine_agent_release="${appd_machine_agent_release:-25.12.0.5064}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-f064c5db1edc25f3300fa6c332cb17f3e0c69ab46010d450faabcf212e639c9e}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="25.12.0.5064"            # [optional] machine agent release (defaults to '25.12.0.5064').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="f064c5db1edc25f3300fa6c332cb17f3e0c69ab46010d450faabcf212e639c9e"
