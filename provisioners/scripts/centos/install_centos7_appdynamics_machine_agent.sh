...
appd_machine_agent_release="${appd_machine_agent_release:-26.1.0.5128}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-5d3dd55ec15c59ce1bfaa8876a9456bc12c2e0744a108540ab96c52879fc7a48}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="26.1.0.5128"             # [optional] machine agent release (defaults to '26.1.0.5128').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="5d3dd55ec15c59ce1bfaa8876a9456bc12c2e0744a108540ab96c52879fc7a48"
