...
appd_machine_agent_release="${appd_machine_agent_release:-23.9.0.3723}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-529ac17274480a14154adcc2d213176b3c36a780d8837641b3ce6c0be6a2543b}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="23.9.0.3723"             # [optional] machine agent release (defaults to '23.9.0.3723').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="529ac17274480a14154adcc2d213176b3c36a780d8837641b3ce6c0be6a2543b"
