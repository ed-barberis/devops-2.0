...
appd_machine_agent_release="${appd_machine_agent_release:-23.7.0.3689}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-f52d2feb61ecbd7794122cd0eb5deca3fb545f3ad5803ee764e98961cc985a6e}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="23.7.0.3689"             # [optional] machine agent release (defaults to '23.7.0.3689').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="f52d2feb61ecbd7794122cd0eb5deca3fb545f3ad5803ee764e98961cc985a6e"
