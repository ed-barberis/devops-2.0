...
tomcat_release="${tomcat_release:-7.0.96}"                          # [optional] tomcat release (defaults to '7.0.96').
...
Usage:
  ...
  Example:
   # tomcat web server install parameters.
    ...
    [root]# export tomcat_release="7.0.96"                      # [optional] tomcat release (defaults to '7.0.96').
   #
