#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 9.4 by Oracle on CentOS Linux 7.x.
#
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-dde3b0548f3ff36fb176f6b24c1a6136}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
