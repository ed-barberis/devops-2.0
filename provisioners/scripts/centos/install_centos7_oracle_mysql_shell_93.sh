#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 9.3 by Oracle on CentOS Linux 7.x.
#
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-1559c1ac080cbf380b9c93266efcaa09}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
