...
appd_platform_release="${appd_platform_release:-24.2.0.10027}"
appd_platform_sha256="${appd_platform_sha256:-e4fe7fd04699b95de640d178ea2d88003d84c9790a512f2c2bb4da6e03495c11}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="24.2.0.10027"                 # [optional] platform release (defaults to '24.2.0.10027').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="e4fe7fd04699b95de640d178ea2d88003d84c9790a512f2c2bb4da6e03495c11"
