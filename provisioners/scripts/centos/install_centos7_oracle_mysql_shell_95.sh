#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 9.5 by Oracle on CentOS Linux 7.x.
#
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-001fa3a3bf226fb613fa4f55cb62d974}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
else
