...
appd_platform_rel="${appd_platform_rel:-4.5.0.11464}"       # [optional] appd platform release (defaults to '4.5.0.11464').
...
Usage:
  ...
  Example:
   # appd platform install parameters.
    ...
    [root]# export appd_platform_rel="4.5.0.11464"          # [optional] appd platform release (defaults to '4.5.0.11464').
   #
