#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 26.7 by Oracle on CentOS Linux 9.x.
#
...
#
# MySQL Shell 26.7 is highly recommended for use with MySQL Server 26.7.
#
# For more details, please visit:
#   https://dev.mysql.com/doc/mysql-shell/26.7/en/
#   https://dev.mysql.com/doc/mysql-shell/26.7/en/mysql-shell-install-linux-quick.html
#   https://dev.mysql.com/downloads/shell
#   https://dev.mysql.com/doc/relnotes/mysql-shell/26.7/en/
#
...
mysqlsh_release="${mysqlsh_release:-26.7.0-1}"                              # [optional] mysql release version (defaults to '26.7.0-1').
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-090c5fa3f3ed54d31729653830cb1aa8}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  mysqlsh_checksum="${mysqlsh_checksum:-f7857fb8ef1c4ce9b64d5849b285156b}"  # [optional] mysql shell repository arm64 md5 checksum (defaults to published value).
else
...
#   This is the MySQL Shell User Guide extract from the MySQL 26.7 Reference Manual.
#   https://dev.mysql.com/doc/mysql-shell/26.7/en/
#
