...
idea_home="idea"
idea_release="2018.1.5"
idea_build="181.5281.24"

idea_binary="ideaIC-${idea_release}-no-jdk.tar.gz"
...
echo "Installing intellij-idea.desktop in applications menu..."
desktop-file-install --dir=/usr/share/applications/ ./desktops/intellij-idea.desktop
update-desktop-database /usr/share/applications/

# copy intellij idea community edition launcher to devops applications folder. -
echo "Copying intellij-idea.desktop launcher to devops 'applications' folder..."
mkdir -p ${devops_home}/provisioners/scripts/centos/applications
cd ${devops_home}/provisioners/scripts/centos/applications
cp -f /usr/share/applications/intellij-idea.desktop .
chmod 755 ./intellij-idea.desktop
