...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-3508fbda4c1b0e27883af9ce0733a0fd}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
#####elif [ "$cpu_arch" = "aarch64" ]; then
#####  # set the arm64 variables.
#####  mysqlsh_checksum="${mysqlsh_checksum:-052d2e469a4b05efb357bf225da043d8}"  # [optional] mysql shell repository arm64 md5 checksum (defaults to published value).
else
