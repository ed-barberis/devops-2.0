...
mysqlsh_release="${mysqlsh_release:-8.0.45-1}"                              # [optional] mysql release version (defaults to '8.0.45-1').
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-59ec74bd6c7e16a85d64ad5846a30776}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  mysqlsh_checksum="${mysqlsh_checksum:-a225c98126a9b3f340d89c8a705da23d}"  # [optional] mysql shell repository arm64 md5 checksum (defaults to published value).
else
