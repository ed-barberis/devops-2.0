...
dc_completion_release="${dc_completion_release:-1.25.0}"
...
Usage:
  ...
  Example:
    ...
    [root]# export dc_completion_release="1.25.0"               # [optional] docker compose completion for bash release (defaults to '1.25.0').
