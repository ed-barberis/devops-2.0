...
tomcat_release="${tomcat_release:-8.5.47}"                          # [optional] tomcat release (defaults to '8.5.47').
...
Usage:
  ...
  Example:
   # tomcat web server install parameters.
    ...
    [root]# export tomcat_release="8.5.47"                      # [optional] tomcat release (defaults to '8.5.47').
   #
