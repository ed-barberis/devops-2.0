#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 9.5 by Oracle on CentOS Linux 8.x.
#
...
#
# MySQL Shell 9.5 is highly recommended for use with MySQL Server 9.5.
#
# For more details, please visit:
#   https://dev.mysql.com/doc/mysql-shell/9.5/en/
#   https://dev.mysql.com/doc/mysql-shell/9.5/en/mysql-shell-install-linux-quick.html
#   https://dev.mysql.com/downloads/shell
#   https://dev.mysql.com/doc/relnotes/mysql-shell/9.5/en/
#
...
mysqlsh_release="${mysqlsh_release:-9.5.0-1}"                               # [optional] mysql release version (defaults to '9.5.0-1').
...
if [ "$cpu_arch" = "x86_64" ]; then
  ...
  mysqlsh_checksum="${mysqlsh_checksum:-2fc469a420b65a50200421436ebdea90}"  # [optional] mysql shell repository amd64 md5 checksum (defaults to published value).
elif [ "$cpu_arch" = "aarch64" ]; then
  # set the arm64 variables.
  mysqlsh_checksum="${mysqlsh_checksum:-e25c2cdf78d9f8446b218191e94aa538}"  # [optional] mysql shell repository arm64 md5 checksum (defaults to published value).
else
...
#   This is the MySQL Shell User Guide extract from the MySQL 9.5 Reference Manual.
#   https://dev.mysql.com/doc/mysql-shell-excerpt/9.5/en/
#
