#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install MySQL Shell 9.0 by Oracle on CentOS Linux 9.x.
#
...
mysqlsh_checksum="${mysqlsh_checksum:-e99e304e24423ce29ad95cfb964f48dc}"    # [optional] mysql shell repository md5 checksum (defaults to published value).
