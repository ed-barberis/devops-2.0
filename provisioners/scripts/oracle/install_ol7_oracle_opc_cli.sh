...
cd /home/vagrant
awk -v opc_profile_directory=${opc_cli_profile_directory} -v opc_profile_file=${opc_cli_profile_file} -f /tmp/scripts/oracle/enable_ol7_oracle_opc_cli.awk /tmp/scripts/oracle/users/user-vagrant-bashrc.sh > .bashrc.${curdate}.opc-cli
