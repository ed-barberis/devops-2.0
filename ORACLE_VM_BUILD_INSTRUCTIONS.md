...
-	Amazon AWS CLI 2.23.5 (command-line interface) [Optional]
-	Ansible 2.9.27
-	Ant 1.10.15
-	Consul 1.20.2
...
-	GitLab Community Edition 17.8.1
-	Jenkins 2.479.3 LTS

In addition, the following application performance management applications are pre-installed in the __APM VM__ (headless):

-	AppDynamics Enterprise Console 24.10.1 Build 10032
...
-	AppDynamics Machine Agent 24.12.0 Build 4485
	-	AppDynamics AWS EC2 Monitoring Extension 2.1.5 [Optional]
-	Atom Editor 1.57.0
-	Brackets Editor 1.7 Experimental 1.7.0-0
-	Chrome 132.0.6834.111 (64-bit)
-	Firefox 102.10.0esr (64-bit)
-	JetBrains IntelliJ IDEA 2024.3.2.1 (Community Edition)
-	JetBrains IntelliJ IDEA 2024.3.2.1 (Ultimate Edition)
-	JetBrains WebStorm 2024.3.2.1 (JavaScript IDE)
-	Postman 11.29.5
