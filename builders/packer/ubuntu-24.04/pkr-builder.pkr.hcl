...
build {
  ...
  provisioner "shell" {
    ...
    expect_disconnect = true
    scripts           = [
      "${path.root}/../../../submodules/chef/bento/packer_templates/scripts/ubuntu/networking_ubuntu.sh",
      "${path.root}/../../../submodules/chef/bento/packer_templates/scripts/ubuntu/sudoers_ubuntu.sh",
      "${path.root}/../../../submodules/chef/bento/packer_templates/scripts/ubuntu/systemd_ubuntu.sh"
    ]
  }
  ...
  provisioner "shell" {
    environment_vars  = [
      ...
      "d_completion_release=${var.docker_completion_release}",
    ...
    pause_before      = "10s"
    scripts           = [
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_devops_tools.sh",
      ...
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_docker.sh",
      "${path.root}/../../../provisioners/scripts/common/install_docker_compose_5.sh",
#     "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_podman.sh",
#     "${path.root}/../../../provisioners/scripts/common/install_ubuntu_podman_compose.sh",
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_ansible.sh",
      ...
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_git.sh",
      "${path.root}/../../../provisioners/scripts/common/install_git_flow.sh",
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_neofetch.sh",
...
#     "${path.root}/../../../provisioners/scripts/common/install_aws_kubectl_cli.sh",
      ...
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_vim_9.sh",
      ...
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_xmlstarlet_xml_processor.sh",
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_mongodb_community_server_8.sh",
      "${path.root}/../../../provisioners/scripts/centos/install_centos7_apache_tomcat_11.sh",
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_mariadb_community_server_12.sh",
...
#     "${path.root}/../../../provisioners/scripts/common/install_appdynamics_nodejs_serverless_tracer.sh",
  ...
  # create splunk user and configure environment.
  provisioner "shell" {
    # This provisioner only runs for the 'virtualbox-iso.vm' source.
    ...
    environment_vars  = [
      ...
      "https_proxy=${var.https_proxy}",
      "no_proxy=${var.no_proxy}",
      "user_name=${var.splunk_ssh_username}",
      "user_group=${var.splunk_ssh_group}",
      "user_password=${var.splunk_user_password}",
      "user_comment=${var.splunk_user_comment}",
      "user_sudo_privileges=${var.splunk_user_sudo_privileges}",
      "user_home=${var.splunk_user_home}",
      "user_login_shell=${var.splunk_user_login_shell}",
      "user_install_headless_env=${var.splunk_user_install_headless_env}",
      "user_docker_profile=${var.splunk_user_docker_profile}",
      "user_prompt_color=${var.splunk_user_prompt_color}"
    ]
    execute_command   = "echo '${var.ssh_password}' | {{ .Vars }} sudo -S -E bash -eux '{{ .Path }}'"
    expect_disconnect = true
    pause_before      = "10s"
    scripts           = [
      "${path.root}/../../../provisioners/scripts/centos/create_systemd_group.sh",
      "${path.root}/../../../provisioners/scripts/centos/create_systemd_user.sh",
#     "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_splunk_enterprise_9.sh"
      "${path.root}/../../../provisioners/scripts/ubuntu/install_ubuntu_splunk_enterprise_10.sh"
    ]
  }
  ...
  provisioner "shell" {
    ...
    pause_before      = "10s"
    scripts           = [
      "${path.root}/../../../submodules/chef/bento/packer_templates/scripts/ubuntu/cleanup_ubuntu.sh",
      "${path.root}/../../../submodules/chef/bento/packer_templates/scripts/_common/parallels_post_cleanup_debian_ubuntu.sh",
  ...
  post-processor "vagrant" {
    compression_level    = 9
    output               = "${path.root}/../../../../artifacts/ubuntu/ubuntu-${var.os_version}-${var.os_arch}.{{ .Provider }}.box"
