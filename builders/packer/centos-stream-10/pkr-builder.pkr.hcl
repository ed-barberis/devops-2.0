...
#     "${path.root}/../../../provisioners/scripts/centos/install_centos10_oracle_mysql_community_server_97.sh",
#     "${path.root}/../../../provisioners/scripts/centos/install_centos10_oracle_mysql_shell_97.sh",
