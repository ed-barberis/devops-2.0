...
build {
  ...
  provisioner "shell" {
    ...
    pause_before      = "60s"
    scripts           = [
      "${path.root}/../../../provisioners/scripts/centos/install_centos10_headless_devops_tools.sh",
...
#     "${path.root}/../../../provisioners/scripts/common/install_onefetch_cli.sh",
      ...
      "${path.root}/../../../provisioners/scripts/centos/install_centos10_xmlstarlet_xml_processor.sh",
      "${path.root}/../../../provisioners/scripts/centos/install_fedora_mongodb_community_server_8.sh",
      "${path.root}/../../../provisioners/scripts/centos/install_centos7_apache_tomcat_11.sh",
#     "${path.root}/../../../provisioners/scripts/centos/install_centos9_mariadb_community_server_12.sh",
#     "${path.root}/../../../provisioners/scripts/centos/install_centos10_oracle_mysql_community_server_95.sh",
#     "${path.root}/../../../provisioners/scripts/centos/install_centos10_oracle_mysql_shell_95.sh",
...
#     "${path.root}/../../../provisioners/scripts/common/install_appdynamics_nodejs_serverless_tracer.sh",
  ...
  post-processor "vagrant" {
    compression_level    = 9
    output               = "${path.root}/../../../../artifacts/centos-stream/centos-stream-${var.os_version}-${var.os_arch}.{{ .Provider }}.box"
